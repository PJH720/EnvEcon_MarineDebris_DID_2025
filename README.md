...
이 프로젝트는 서강대학교 경제학과 **환경경제학(Environmental Economics, ECO3005)** 2025년 2학기 수업의 **그룹 프로젝트**로 수행되었습니다.
...
2.  **데이터 및 방법론적 한계 (Critical Limitations)**
    ...
    *   **동태적 추이:** Motagua 지역의 잔해 비율은 정책 시행 후 **시간 경과에 따라 유의하게 증가하는 경향**을 보였습니다 ($r=0.2410$, $p=0.0477$). 이는 동태적 추이 가능성을 시사할 수 있으며, DID 분석과 함께 추가적인 심층 분석이 필요합니다.
